...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__product_create_product_create_component__ = __webpack_require__("../../../../../src/app/product-create/product-create.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    {
        path: 'product-create',
        component: __WEBPACK_IMPORTED_MODULE_11__product_create_product_create_component__["a" /* ProductCreateComponent */],
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__product_create_product_create_component__["a" /* ProductCreateComponent */]
            ],
            imports: [
...
var ContactEditComponent = /** @class */ (function () {
    ...
    ContactEditComponent.prototype.deleteContact = function (id) {
        var _this = this;
...
var ProductCreateComponent = /** @class */ (function () {
    ...
    ProductCreateComponent.prototype.saveProduct = function () {
        ...
        this.http.post('/addProduct', this.product)
            .subscribe(function (res) {
            _this.router.navigate(['/products', res]);
        }, function (err) {
            console.log(err);
        });
    };
